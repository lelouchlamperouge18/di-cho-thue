import styles from '../../styles/admin/Store.module.css'
...
export default function AdminStore(props) {
    ...
    return (
        <div className="Store">
            <Head>
                <title>Quản lí hồ sơ cửa hàng</title>
                <link rel="icon" href="/favicon.ico" />
            </Head>
            <Sidebar isOpen={isOpen} toggle={toggle}/>
            <Navbar toggle={toggle} />
            <h1 class={styles.title}>
                QUẢN LÍ HỒ SƠ CỬA HÀNG
            </h1>
            ...
            <TableContainer component={Paper}>
                <Table className={styles.table} aria-label="simple table">
                    ...
                    <TableRow>
                        ...
                        <TableCell align="left"><b>Actions (35)</b></TableCell>
                    </TableRow>
                    </TableHead>
                    <TableBody>
                    {data.map((row, key) => (
...
export async function getStaticProps(){
    const data = [
        ...
        {MaNCC: 15, TenNCC: 'Thiết bị y tế Phương Hoa', GiayPhepKinhDoanh: 'GP10112023', SDT: '013243243', Email: 'ph@yahoo.com', TinhTP: 'TPHCM', LoaiVungDich: 'Vùng đỏ'},
    ]
    return {
        props: {data}
    }
